...
{
    public class WaitingOrderAutionAucController : BaseController
    {
        ...
        public WaitingOrderAutionAucController(ILogger<OrderController> logger,
        ...
        public async Task<IActionResult> Export(OrderListRequest request)
        {
            try
            {
                ...
                using (var package = new ExcelPackage(fileInfo, true))
                {
                    ...
                    workSheet.Cells["D2"].Value = "Đơn Chờ Tất Toán AUC " + String.Format("{0:dd/MM/yyyy}", time);
