...
{
    public class PurchaseWaitingMercariController : BaseController
    {
        ...
        public PurchaseWaitingMercariController(ILogger<PurchaseBuyForYouController> logger,
        ...
        public async Task<IActionResult> GetJTable(OrderBuyForYouListJTableModel request)
        {
            try
            {
                ...
                var response = await orderBuyForYouAppService.GetListJTablePurchaseMercari(appserviceRequest);
        ...
        public async Task<IActionResult> Export(OrderBuyForYouListRequest request)
        {
            try
            {
                ...
                {
                    orderLists = await orderBuyForYouAppService.ExportWaitingPurchaseMercari(request);
                }
                ...
                using (var package = new ExcelPackage(fileInfo, true))
                {
                    ...
                    workSheet.Cells["D2"].Value = "Đơn chờ mua Mercari " + String.Format("{0:dd/MM/yyyy}", time);
