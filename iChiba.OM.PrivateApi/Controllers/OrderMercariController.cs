...
{
    public class OrderMercariController : BaseController
    {
        ...
        public OrderMercariController(ILogger<OrderBuyForYouController> logger,
            ...
            ILevelAppService levelAppService,
            IProductFromUrlAppService productFromYrlAppService,
            ...
            IWarehouseAppService warehouseAppService, AccessClient accessClient, AppConfig appConfig) : base(logger, accessClient, appConfig)
        {
            ...
            this.walletAppService = walletAppService;
            this.levelAppService = levelAppService;
            this.productFromUrlAppService = productFromYrlAppService;
        ...
        public async Task<IActionResult> GetJTable(OrderBuyForYouListJTableModel request)
        {
            try
            {
                ...
                var response = await orderBuyForYouAppService.GetListJTableByMaceri(appserviceRequest);
        ...
        [ProducesResponseType((int)HttpStatusCode.Forbidden)]
        [ProducesResponseType((int)HttpStatusCode.OK, Type = typeof(OrderBuyForYouListJTableModel))]
        public async Task<IActionResult> GetJTableBuyPayPriceMercari(OrderBuyForYouListJTableModel request)
        {
            try
            {
        ...
        [ProducesResponseType((int)HttpStatusCode.Forbidden)]
        [ProducesResponseType((int)HttpStatusCode.OK, Type = typeof(OrderBuyForYouListJTableModel))]
        public async Task<IActionResult> GetJTableBuyMercariBought(OrderBuyForYouListJTableModel request)
        {
            try
            {
                if (!string.IsNullOrWhiteSpace(request.RefType)
        ...
        [ProducesResponseType((int)HttpStatusCode.Forbidden)]
        [ProducesResponseType((int)HttpStatusCode.OK, Type = typeof(OrderBuyForYouListJTableModel))]
        public async Task<IActionResult> GetJTableBuyMercariCancel(OrderBuyForYouListJTableModel request)
        {
            try
            {
                if (!string.IsNullOrWhiteSpace(request.RefType)
                ...
                var response = await orderBuyForYouAppService.GetOrderCancelMercariJTable(appserviceRequest);
                var responseJTable = JTableHelper.JObjectTable(response.Data.ToList(),
                     request.Draw,
                    response.Total);
        ...
        [ProducesResponseType((int)HttpStatusCode.Forbidden)]
        [ProducesResponseType((int)HttpStatusCode.OK, Type = typeof(OrderBuyForYouListJTableModel))]
        public async Task<IActionResult> GetJTableBuyWaitingBoughtMercari(OrderBuyForYouListJTableModel request)
        {
            try
            {
                if (!string.IsNullOrWhiteSpace(request.RefType)
                ...
                var appserviceRequest = request.ToModel();
                var response = await orderBuyForYouAppService.ExportWaitingPurchaseMercari(appserviceRequest);
                var responseJTable = JTableHelper.JObjectTable(response.Data.ToList(),
                     request.Draw,
                    response.Total);
        ...
        public async Task<IActionResult> ExportOrderMercari(OrderBuyForYouListRequest request)
        {
            try
            {
                if (!string.IsNullOrWhiteSpace(request.RefType)
                ...
                var data = await orderBuyForYouAppService.ExportOrderMercari(request);
                if (data == null)
                {
                ...
                using (var package = new ExcelPackage(fileInfo, true))
                {
                    ...
                    workSheet.Cells["D2"].Value = "Đơn hàng mercari " + String.Format("{0:dd/MM/yyyy}", time);
        ...
        [ProducesResponseType((int)HttpStatusCode.Forbidden)]
        [ProducesResponseType((int)HttpStatusCode.OK, Type = typeof(BaseResponse))]
        public async Task<IActionResult> ExportWaitingMercari(OrderBuyForYouListRequest request)
        {
            try
            {
                if (!string.IsNullOrWhiteSpace(request.RefType)
                ...
                var data = await orderBuyForYouAppService.ExportOrderPayPriceMercari(request);
                if (data == null)
                {
                    throw new ErrorCodeException(ErrorCodeDefine.EXPORT_MESSAGE);
                }
                ...
                using (var package = new ExcelPackage(fileInfo, true))
                {
                    ...
                    workSheet.Cells["H8:H" + (data.Data.Count + 8)].Style.Numberformat.Format = "#,##";
                    workSheet.Cells["I8:I" + (data.Data.Count + 8)].Style.Numberformat.Format = "#,##";
                    workSheet.Cells["J8:J" + (data.Data.Count + 8)].Style.Numberformat.Format = "#,##";
                    workSheet.Cells["N8:N" + (data.Data.Count + 8)].Style.Numberformat.Format = "#,##";
        ...
        [ProducesResponseType((int)HttpStatusCode.Forbidden)]
        [ProducesResponseType((int)HttpStatusCode.OK, Type = typeof(BaseResponse))]
        public async Task<IActionResult> ExportMercariBought(OrderBuyForYouListRequest request)
        {
            try
            {
                if (!string.IsNullOrWhiteSpace(request.RefType)
                ...
                var data = await orderBuyForYouAppService.ExportPurchaseMercari(request);
                if (data == null)
                {
                    throw new ErrorCodeException(ErrorCodeDefine.EXPORT_MESSAGE);
                }
        ...
        public async Task<IActionResult> AddNewOrder(OrderBuyForYouAddRequest request)
        {
            ...
            var response = await orderBuyForYouAppService.AddNewOrderMercari(request);
            return Ok(response);
        }
        ...
        public async Task<IActionResult> GetProductUrl(ProductDetailFromUrlRequest request)
        {
            try
            {
                var data = await productFromUrlAppService.Detail(request);
                return Ok(data);
            }
            catch (Exception ex)
            {
        ...
        [ProducesResponseType((int)HttpStatusCode.Forbidden)]
        [ProducesResponseType((int)HttpStatusCode.OK, Type = typeof(BaseResponse))]
        public async Task<IActionResult> UpdateProductFromUrl(OrderDetailUpdateFromUrlRequest request)
        {
            try
            {
                var response = await orderBuyForYouAppService.UpdateProductFromUrl(request);
                return Ok(response);
            }
            catch (Exception ex)
            {
        ...
        [ProducesResponseType((int)HttpStatusCode.Forbidden)]
        [ProducesResponseType((int)HttpStatusCode.OK, Type = typeof(OrderDetailUpdateResponse))]
        public async Task<IActionResult> AddPaymentMercari(PaymentAddRequest request)
        {
            try
            {
