...
namespace iChiba.OM.PrivateApi.Controllers
{
    public class RefundTransactionController : BaseController
    {
        ...
        public RefundTransactionController(ILogger<DepositsController> logger,
        ...
        public async Task<IActionResult> GetJTable(DepositsListJTableModel request)
        {
            try
            {
                ...
                var response = await depositsAppService.GetListJTableRefundTransaction(appserviceRequest);
