...
{
    public class ProcessDepositeController : BaseController
    {
        ...
        private const string processDepositeStatus = "1";

        public ProcessDepositeController(ILogger<DepositsController> logger,
        ...
        public async Task<IActionResult> GetJTable(DepositsListJTableModel request)
        {
            try
            {
                ...
                appserviceRequest.DepositSt = processDepositeStatus;
