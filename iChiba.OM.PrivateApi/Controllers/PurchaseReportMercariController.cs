...
namespace iChiba.OM.PrivateApi.Controllers
{
    ...
    public class PurchaseReportMercariController : BaseController
    {
        private readonly IPurchaseReportAppService purchaseReportService;
        private readonly IHostingEnvironment environment;
        public PurchaseReportMercariController(ILogger<PurchaseReportController> logger, IPurchaseReportAppService purchaseReportService, IHostingEnvironment environment) : base(logger)
        {
        ...
        public async Task<IActionResult> GetPurchaseReportMercari()
        {
            try
            {
                var response = await purchaseReportService.GetPurchaseReportME();
        ...
        [ProducesResponseType((int)HttpStatusCode.Forbidden)]
        [ProducesResponseType((int)HttpStatusCode.OK, Type = typeof(BaseResponse))]
        public async Task<IActionResult> GetPurchaseReportDataMercari(PurchaseReportMercariRequest request)
        {
            try
            {
                var data = await purchaseReportService.GetPurchaseReportDataMercari(request);
                return Ok(data);
            }
            catch (Exception ex)
            {
