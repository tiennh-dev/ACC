...
{
    public class OrderAuctionPretreatmentController : BaseController
    {
        ...
        public OrderAuctionPretreatmentController(ILogger<OrderAuctionPretreatmentController> logger,
