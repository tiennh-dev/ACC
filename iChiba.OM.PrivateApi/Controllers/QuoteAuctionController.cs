...
{
    public class QuoteAuctionController : BaseController
    {
        ...
        public QuoteAuctionController(ILogger<QuoteAuctionController> logger,
        ...
        public async Task<IActionResult> GetJTable(OrderListJTableModel request)
        {
            try
            {
                ...
                {
                    appserviceRequest.OrderType = OrderRefType.AUCTION;
                            ...
                            for (i = 2; i <= rows; i++)
                            {
                                ...
                                try
                                {
                                    try
                                    {
                                        ...
                                        weight = Convert.ToDouble(worksheet.Cells[i, 3].Value.ToString().Trim());
